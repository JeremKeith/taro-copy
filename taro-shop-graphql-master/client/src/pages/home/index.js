...
class Home extends Component {
          ...
          if (res.code) {
            ...
            Taro.request({
              ...
              .then((res1) => {
                ...
                setGlobalData('openid', 'o2fcFv8x3wy5WtcP116S5GzzkgDQ')
                setGlobalData('user_id', 'user_1556085732950_50288036')
              })
              .catch((error) => {
  ...
  getSlideShow = () => {
    findMany({collection:"shop",fields:["id","slideshow"]}).then((res)=>{
      console.log("getSlideShow res",res)
      let swiperList = []
      res.forEach((item,index)=>{
         swiperList.push(item.slideshow)
